...
def main() -> int:
    ...
    eprint(f"ai-watermark-remover: {len(actionable)} file(s) carry AI/C2PA provenance marks:")
    ...
    eprint(
        ...
        "(or the ai-watermark-remover-clean pre-commit hook) to strip these before committing."
    )
    return 1
