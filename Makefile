...
docker-synthid-build:
	docker build -f service/Dockerfile.synthid -t ai-watermark-remover-synthid-scorer service/

docker-synthid-help:
	docker run --rm ai-watermark-remover-synthid-scorer --help
...
docker-ctrlregen-build:
	docker build -f service/Dockerfile.ctrlregen -t ai-watermark-remover-ctrlregen service/

docker-ctrlregen-help:
	docker run --rm ai-watermark-remover-ctrlregen --help
...
docker-markllm-build:
	docker build -f service/Dockerfile.markllm -t ai-watermark-remover-markllm service/

docker-markllm-help:
	docker run --rm ai-watermark-remover-markllm --help
...
docker-markdiffusion-build:
	docker build -f service/Dockerfile.markdiffusion -t ai-watermark-remover-markdiffusion service/

docker-markdiffusion-help:
	docker run --rm ai-watermark-remover-markdiffusion --help

# Core HTTP service (text + file/image metadata cleaning).
docker-core-build:
	docker build -f service/Dockerfile -t ai-watermark-remover service/

docker-core-help:
	docker run --rm ai-watermark-remover /app/scripts/server.py --help
